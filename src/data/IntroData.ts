...
const intro_data: DataType[] = [
   {
      ...
      desc: "Especialización en diseño y fabricación de prótesis dentales de alta calidad"
   },
   {
      id: 2,
      page: "home_1",
      ...
      desc: "Formación en las últimas tecnologías CAD/CAM y escaneado 3D"
   },
   {
      id: 3,
      page: "home_1",
      ...
      desc: "Prácticas en instalaciones equipadas con tecnología de última generación"
   },
